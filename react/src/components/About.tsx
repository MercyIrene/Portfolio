...
export function About() {
  ...
  return <section id="about" ref={ref} className={`py-20 px-4 md:px-8 max-w-5xl mx-auto transition-all duration-1000 scroll-mt-24 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="relative group">
          ...
          <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-purple-500/30">
            <img src="/images/try_pic.jpg" alt="Mercy Irene Wangari" className="w-full h-full object-cover" loading="lazy" />
        ...
        <div>
          ...
          <div className="space-y-4 text-gray-400 leading-relaxed">
            <p>
              A Mechatronics Engineer with a passion for creating
            ...
            <p>
              ...
              architecture, I bring a unique perspective that combines mechanical
              precision, electronic innovation, and software elegance. 
            </p>
